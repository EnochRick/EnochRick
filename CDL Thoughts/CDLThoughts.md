...
Furthermore: I have the utmost respect and admiration of the team that has incepted and built CDL.  I consider them to be giants in the industry and I apprecate all their hard work.  The following text in this document is not intended to be negative or an attack on their efforts but rather an honest outside opinion on what needs working on to get CDL to acheive the success we all collectively want it to acheive.  My opionions on this are exactly that.  Thank you to the CDL team for building first the idea and then the implemenation of CDL, without your work, this idea would not be planted solidly in the fertile soils it is currently germinating in.  I hope to help cultivate the fruits of your hard work in the future.  ✌️
...
### My thoughts on the Benefits of open source - where CDL could realy provide more value:
...
block LinearScale
  ...
  Interfaces.RealInput y2 "Second x cooridnate";
  Interfaces.RealInput i "connector for signal to be scaled";
  Interfaces.RealOutput o "connector of the real output signal";
equation
